...
// echarts字体适配屏幕大小
export const fontSizeComp = (val, initWidth = 1920) => {
	const nowClientWidth = document.documentElement.clientWidth
	return val * (nowClientWidth / initWidth)
}
// echarts渐变色生成
export const createColor = colorArr => {
...
// 获取各市州中心点位置
export const getCenterPoint = features => {
	function getName (name) {
		if (name === '临夏回族自治州') return '临夏'
		if (name === '甘南藏族自治州') return '甘南'
		return name
	}
